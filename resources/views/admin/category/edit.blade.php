        ...
        <div class="card-body">
            <form action="{{ route('admin#categoryUpdate',$updateData['id'])}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{old ('categoryName',$updateData['title'])}}" name="categoryName" placeholder="Enter Category">
                    @error('categoryName')
                ...
                <div class="form-group">
                    ...
                    <textarea id="" cols="30"class="form-control" name="categoryDescription" rows="10">{{old('categoryDescription',$updateData['description'])}}</textarea>
                    @error('categoryDescription')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                </div>
                <button class="submit" class="btn btn-info">Update</button>
            </form>
        </div>
    </div>
</div>
